...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    specs: { 'جنس': 'برنج جامد', 'پوشش': 'کروم براق', 'گارانتی': '۵ سال', 'سبک': 'نیمه سنگین' },
  ...
  },
  {
    ...
    specs: { 'جنس': 'فولاد ضد زنگ', 'نوع علمک': 'شیلنگدار', 'گارانتی': '۷ سال', 'سبک': 'سبک' },
    images: placeholderImages,
    isNew: true,
  },
  {
    ...
    specs: { 'جنس': 'برنج', 'نرخ جریان': '۲.۵ GPM', 'گارانتی': '۱۰ سال', 'سبک': 'سنگین' },
    images: placeholderImages,
    isBestSeller: true,
  },
    {
    ...
    specs: { 'جنس': 'برنج جامد', 'آبفشان': 'صرفه‌جویی در آب', 'گارانتی': '۵ سال', 'سبک': 'سبک' },
    images: placeholderImages,
  },
  {
    id: 5,
    ...
    specs: { 'جنس': 'برنج با آبکاری طلا', 'دستگیره‌ها': 'کریستال', 'گارانتی': 'مادام العمر', 'سبک': 'سنگین' },
    images: placeholderImages,
    isNew: true,
  },
   {
    ...
    specs: { 'جنس': 'برنج جامد', 'شیر': 'ترموستاتیک', 'گارانتی': '۵ سال', 'سبک': 'نیمه سنگین' },
    images: placeholderImages,
  },
  {
    id: 7,
    ...
    specs: { 'جنس': 'برنج جامد', 'ارتفاع': '۱۵ سانتی‌متر', 'گارانتی': '۷ سال', 'سبک': 'سبک' },
    images: placeholderImages,
    isBestSeller: true,
  },
   {
    ...
    specs: { 'جنس': 'برنج جامد', 'چرخش علمک': '۳۶۰ درجه', 'گارانتی': '۱۰ سال', 'سبک': 'نیمه سنگین' },
    images: placeholderImages,
    isNew: true,
  }
];