...
export async function verifyDatabaseConnection() {
  ...
  if (useSqlite) {
    verifySqliteConnection();
    const count = sqliteGetAllProducts().length;
    return { mode: 'sqlite', ok: true, productCount: count };
  }
...
export async function createProduct(product) {
  ...
  return sqliteCreateProduct(product);
}
...
export async function updateProduct(id, updates) {
  ...
  return sqliteUpdateProduct(id, updates);
}
