      ...
      <div className="container">
        ...
        <header className="about-hero">
          ...
          <h1 className="about-title">
            شیرآلات تانسو، تلاقی هنر دستی و مهندسی دقیق
          </h1>
        ...
        <section className="about-story">
          ...
          <div className="story-content">
            ...
            <div className="story-heading">
              ...
              <h2>
                ریشه‌های ما؛ از کوره ریخته‌گری تا خانه‌های شما
              </h2>

              <span>
                تأسیس 1395 • کارگاه تولیدی تانسو
              </span>

            </div>

            <p>
              تولیدی شیرآلات اهرمی تانسو از پنج سال پیش با یک هدف
              مشخص فعالیت خود را آغاز کرد؛ ساخت محصولاتی که کیفیت،
            ...
            <p>
              امروز تمامی مراحل تولید،
              مونتاژ و کنترل کیفیت در مجموعه تانسو انجام
              می‌شود و هر قطعه قبل از خروج از کارگاه
              چندین مرحله تست فشار، تست نشتی و کنترل
              ظاهری را پشت سر می‌گذارد.
            </p>
          ...
          <aside className="story-card">
            ...
            <div className="story-card-box">
              ...
              <p>
                ...
                شده محصولات تانسو با همان کیفیت برندهای لوکس
...
<div className="values-grid">
  ...
  <article className="value-card">
    ...
    <p>
      ...
      درخشندگی و مقاومت محصولات آریا در برابر رطوبت،
...
<div className="contact-content">
  ...
  <div className="contact-info">
    ...
    <h2>
      ارتباط مستقیم با کارگاه و پشتیبانی فروش
    </h2>

    <p>
      اگر برای انتخاب محصول، نصب، خدمات پس از فروش،
      سفارش عمده یا دریافت مشاوره تخصصی نیاز به راهنمایی
      دارید، کارشناسان ما آماده پاسخگویی به شما هستند.
    </p>
  ...
  <div className="contact-card">
    ...
    <div className="contact-item">
      ...
      <a href="mailto:tansufaucets@gmail.com">
      tansufaucets@gmail.com
      </a>
